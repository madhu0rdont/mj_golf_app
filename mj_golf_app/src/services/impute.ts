...
// ─── Trackman PGA Tour reference data ───────────────────────────────────────
// Used as baseline for physics-based imputation, scaled to the user's carry.
// Sources: Trackman PGA Tour Averages, empirical launch monitor data.
...
/**
 * Physics-based imputation from carry distance + loft.
 *
 * Interpolates the tour reference data for the given loft, then scales
 * speed-dependent metrics (ball speed, apex height, total) by the ratio
 * of the user's carry to the tour carry at that loft. Launch angle,
 * descent angle, and spin rate are derived primarily from loft since
 * they don't vary much with skill level.
 */
...
// ─── Existing interpolation-based imputation ────────────────────────────────
